#!/usr/bin/env bash
################################################################################
# deploy-web.sh - Deploy jd-assistant to GitHub Pages
#
...
PROJECT_NAME="jd-assistant"
GITHUB_USER="bordenet"
GITHUB_REPO="jd-assistant"
GITHUB_PAGES_URL="https://bordenet.github.io/jd-assistant/"
