 ...
 * @property {string} requiredQualifications - Required qualifications
 * @property {string} preferredQualifications - Preferred qualifications
 * @property {string} compensationRange - Compensation range
 * @property {string} benefits - Benefits highlights
 * @property {string} techStack - Tech stack details
 * @property {string} teamSize - Team size/structure
 * @property {string} aiSpecifics - Applied AI specifics
 * @property {string} careerLadder - Company career ladder
 * @property {string} companyPreamble - Company preamble (EEO, diversity)
 * @property {string} companyLegalText - Company legal text
 ...
 * @property {string} [aiSpecifics] - Applied AI specifics
 * @property {string} [careerLadder] - Company career ladder
 * @property {string} [companyPreamble] - Company preamble
 * @property {string} [companyLegalText] - Company legal text
 */
