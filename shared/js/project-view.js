...
import { getPhaseMetadata, getFinalMarkdown, getExportFilename, WORKFLOW_CONFIG } from './workflow.js';
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        ${project.companyName || ''} ${project.location ? `• ${project.location}` : ''}
                        ${project.roleLevel ? `• ${project.roleLevel}` : ''}
                    </p>
                </div>
