 ...
 * Handles importing existing Job Descriptions from Word/Google Docs via paste
 */
...
export function showImportModal() {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      const title = titleMatch ? titleMatch[1].replace(/^Job Description:\s*/i, '').trim() : `Imported ${DOC_TYPE_SHORT}`;
